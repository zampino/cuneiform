...
public abstract class Invocation {
	 ...
	 * independent of the channel in which they appear.
	 * 
	 * This method assumes that the method Invocation.evalReport() has been
	 * called with the report created during execution of this invocation.
